...
function validatePhone($phone) {
    ...
    // Accept 5-15 digits to support international numbers (ITU-T E.164)
    return strlen($phone) >= 5 && strlen($phone) <= 15;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $countryCode = isset($input['countryCode']) ? sanitizeInput($input['countryCode']) : null;
